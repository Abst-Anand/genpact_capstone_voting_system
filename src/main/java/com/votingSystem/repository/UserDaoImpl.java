...
public class UserDaoImpl implements UserDao {
	...
	public int revokeAuthority(int subAdminId) throws SerialException, IOException, SQLException {
		...
		String query = "UPDATE users " + "SET is_authority_revoked = CASE " + "WHEN is_authority_revoked = 0 THEN 1 "
				+ "ELSE 0 " + "END " + "WHERE user_id = ?";
	...
	public int isApproved(int voterId) throws SerialException, IOException, SQLException {
		...
		String query = "UPDATE users " + "SET is_approved = CASE " + "WHEN is_approved = 0 THEN 1 " + "ELSE 0 " + "END "
				+ "WHERE user_id = ?";
